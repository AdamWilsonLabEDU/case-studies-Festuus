...
CO2mean %>%
 arrange(desc(Mean)) %>%  
  ...
  as_image(width = 30, file = "table.png")
```

```{r}
#quarto::render("/Users/festusad/Documents/SpatialDataScience/Case_Assignments/week_08/Quarto.qmd", output_format = c("html_document", "pdf_document"))
